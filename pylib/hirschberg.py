...
def tabulate_lcs(seq1, seq2, *args):
    """Calls helper function to calculate an LCS. ALG B in Hirschberg.
...
def reconstruct_lcs(seq1, seq2):
    """Calls helper function to construct LCS. ALG C in Hirschberg."""
    # reset registry
...
def _reconstruct_lcs(seq1, seq2, m, n):
    ...
    if n == 0:
        ...
        _tabulate_lcs(seq1[:mid], seq2, mid+1, n+1, lcs_vector_1)
        ...
        C1 = _reconstruct_lcs(seq1[:mid], seq2[:k], mid, min(k, n))
        C2 = _reconstruct_lcs(seq1[mid:], seq2[k:], m-mid, n-min(k, n))
        C1.extend(C2)
        return C1
